    ...
    <div class="limiter">
        <div class="container-login100" style="background-image: url('images/bg-01.jpg');">
            <div class="wrap-login100" style="background: #31548a;">
                <form action="config/add_ws.php" method="post" class="login100-form validate-form" enctype="multipart/form-data">
                    ...
                    <!-- alasan -->
                    <div class="wrap-input100 validate-input" data-validate="Masukkan Alasan Anda">
                    ...
                    <div class="wrap-input100">
                        ...
                        <p style="color:white">*Mohon Masukkan data CV (.pdf)</p>
                        <input type="file" name="file" required>
                        <!-- <span class="focus-input100" data-placeholder="&#xf227;"></span> <br><br> -->
                    </div>
                    <!-- link wa -->
                    <!-- login -->
