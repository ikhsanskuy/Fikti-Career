...
<body>
    <div class="table-responsive jumbotron">
        <h2>Data pendaftar workshop</h2>
        <a href="excel/workshop_excel.php" class="btn btn-success">Report Excel</a>
            ...
            ?>
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a class="btn-danger" onclick="return confirm('Apakah file ingin dihapus?')" href="../config/hapus_ws.php?id=<?php echo $data['id']; ?> "><i class="fa fa-trash" style="padding: 3px; border-radius:30%;"></i></a>
                        </td>
