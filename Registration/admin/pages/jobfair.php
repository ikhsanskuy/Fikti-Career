...
<body>
    <div class="table-responsive jumbotron">
        <h2>Data pendaftar JobFair</h2>
        <a href="excel/jobfair_excel.php" class="btn btn-success">Report Excel</a>
        <table id="data-example" class="table table-striped table-bordered table-hover" style="width:100%">
            <thead>
                <tr>
                    ...
                    <th scope="col" width="130px">Alasan</th>
            ...
            ?>
                <tbody>
                    <tr>
                        ...
                        <td>
                            <a class="btn-danger" onclick="return confirm('Apakah file ingin dihapus?')" href="../config/hapus_jf.php?id=<?php echo $data['id']; ?> "><i class="fa fa-trash" style="padding: 3px; border-radius:30%;"></i></a>
                        </td>
                    </tr>
                </tbody>
            <?php
